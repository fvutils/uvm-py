...
# @uvm.uvm_macros.uvm_object_utils
...
#  `uvm_object_utils(uvm_report_handler)
    ...
    def __init__(self, name = "uvm_report_handler"):
        super().__init__(name)
        self.supernew=name;
...
#             l_str);
#         end
#       end while(id_verbositiesnext=idx);
...
#         "array");
#       if(severity_id_verbositiesfirst=l_severity) begin
#         do begin
#           uvm_id_verbosities_array id_v_ary = severity_id_verbosities[l_severity];
#           if(id_v_aryfirst=idx)
#           do begin
#             l_int = id_v_aryget=idx;
#             if ($cast(l_verbosity, l_int))
...
# 				    "int", 32, l_str);
#             end
#           end while(id_v_arynext=idx);
#         end while(severity_id_verbositiesnext=l_severity);
#       end
#       printer.print_array_footer();
#     end
# 
#     # id actions
#     if(id_actionsfirst=idx) begin
#       printer.print_array_header("id_actions",id_actions.num(),
#         "uvm_pool");
#       do begin
#         l_int = id_actionsget=idx;
#         printer.print_generic($sformatf("[%s]", idx), "uvm_action", 32, 
#           format_action(l_int));
#       end while(id_actionsnext=idx);
#       printer.print_array_footer();
#     end
# 
#     # severity actions
#     if(severity_actionsfirst=l_severity) begin
...
#       end while(severity_actionsnext=l_severity);
#       printer.print_array_footer();
#     end
# 
#     # sev and id actions 
...
#         "array");
#       if(severity_id_actionsfirst=l_severity) begin
#         do begin
#           uvm_id_actions_array id_a_ary = severity_id_actions[l_severity];
#           if(id_a_aryfirst=idx)
#           do begin
#             printer.print_generic($sformatf("[%s:%s]", l_severity.name(), idx), 
# 				  "uvm_action", 32, format_action(id_a_aryget=idx));
#           end while(id_a_arynext=idx);
#         end while(severity_id_actionsnext=l_severity);
#       end
#       printer.print_array_footer();
#     end
# 
#     # sev overrides
#     if(sev_overridesfirst=l_severity) begin
#       printer.print_array_header("sev_overrides",sev_overrides.num(),
#         "uvm_pool");
#       do begin
#         uvm_severity l_severity_new = sev_overridesget=l_severity;
#         printer.print_generic($sformatf("[%s]", l_severity.name()),
#           "uvm_severity", 32, l_severity_new.name());
#       end while(sev_overridesnext=l_severity);
#       printer.print_array_footer();
#     end
# 
...
#         "array");
#       if(sev_id_overridesfirst=idx) begin
#         do begin
#           uvm_sev_override_array sev_o_ary = sev_id_overrides[idx];
#           if(sev_o_aryfirst=l_severity)
#           do begin
#             uvm_severity new_sev = sev_o_aryget=l_severity;
#             printer.print_generic($sformatf("[%s:%s]", l_severity.name(), idx), 
#               "uvm_severity", 32, new_sev.name());
#           end while(sev_o_arynext=l_severity);
#         end while(sev_id_overridesnext=idx);
#       end
#       printer.print_array_footer();
#     end
# 
...
# 
#     # id files 
#     if(id_file_handlesfirst=idx) begin
#       printer.print_array_header("id_file_handles",id_file_handles.num(),
#         "uvm_pool");
#       do begin
#         printer.print_field($sformatf("[%s]", idx), id_file_handlesget=idx, 32,
#           UVM_HEX, ".", "UVM_FILE");
#       end while(id_file_handlesnext=idx);
#       printer.print_array_footer();
#     end
# 
#     # severity files
#     if(severity_file_handlesfirst=l_severity) begin
...
#       end while(severity_file_handlesnext=l_severity);
#       printer.print_array_footer();
#     end
# 
#     # sev and id files
...
#         "array");
#       if(severity_id_file_handlesfirst=l_severity) begin
#         do begin
#           uvm_id_file_array id_f_ary = severity_id_file_handles[l_severity];
#           if(id_f_aryfirst=idx)
#           do begin
#             printer.print_field($sformatf("[%s:%s]", l_severity.name(), idx),
#               id_f_aryget=idx, 32, UVM_HEX, ".", "UVM_FILE");
#           end while(id_f_arynext=idx);
#         end while(severity_id_file_handlesnext=l_severity);
#       end
#       printer.print_array_footer();
#     end
# 
...
#     if(sev_id_overridesexists=id) begin
#       if(sev_id_overrides[id].exists(uvm_severity'(severity))) begin
#         severity = sev_id_overrides[id]get=severity;
#         report_messageset_severity=severity;
#       end
#     end
#     else begin
#       if(sev_overridesexists=severity) begin
#         severity = sev_overridesget=severity;
#         report_messageset_severity=severity;
#       end
#     end
#     report_message.set_file(get_file_handle(severity, id));
#     report_messageset_report_handler=this;
#     report_message.set_action(get_action(severity, id));
#     srvrprocess_report_message=report_message;
#     
#   endfunction
# 
# 
...
# 
#     if(severity_id_file_handlesexists=severity) begin
...
# 
# 
#     if(id_file_handlesexists=id)
#       return id_file_handlesget=id;
# 
#     if(severity_file_handlesexists=severity)
...
#     if(severity_id_verbositiesexists=severity) begin
#       array = severity_id_verbosities[severity];
#       if(arrayexists=id) begin
#         return arrayget=id;
#       end
#     end
# 
#     if(id_verbositiesexists=id) begin
#       return id_verbositiesget=id;
#     end
# 
...
#     if(severity_id_actionsexists=severity) begin
#       array = severity_id_actions[severity];
#       if(arrayexists=id)
#         return arrayget=id;
#     end
# 
#     if(id_actionsexists=id)
#       return id_actionsget=id;
# 
...
#       return file;
#   
#     if (id_file_handlesexists=id) begin
#       file = id_file_handlesget=id;
#       if (file != 0)
#         return file;
#     end
# 
#     if (severity_file_handlesexists=severity) begin
...
#                                        string id,
#                                        uvm_action action);
#     if(!severity_id_actionsexists=severity)
...
#                                        string id,
#                                        int verbosity);
#     if(!severity_id_verbositiesexists=severity)
...
#     if(!severity_id_file_handlesexists=severity)
...
#     l_report_messageset_report_object=client;
