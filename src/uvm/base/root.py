...
#        l_rs.report_summarize();
        ...
        m_uvm_core_state = uvm_core_state.FINISHED
...
#     extern local function void m_process_default_sequence(string cfg);
    def m_check_verbosity(self):
        print("TODO: uvm_root.m_check_verbosity")
        
    def m_check_uvm_field_flag_size(self):
        print("TODO: uvm_root.m_check_uvm_field_flag_size()")
        
    def report_header(self, file=sys.stdout):
        print("TODO: uvm_root.report_header")
    ...
    def run_phase(self, phase):
        ...
        for action in self.m_uvm_applied_cl_action:
            if not action.used:
                # TODO: Error handling
                ...
                pass
        for action in self.m_uvm_applied_cl_sev:
            if not action.used:
                # TODO: Error handling
    ...
    def phase_started(self, phase):
        if phase == self.end_of_elaboration_ph:
