...
UVM_FIELD_FLAG_RESERVED_BITS = 28
...
def uvm_radix_to_string(radix):
    radix_m = {
        uvm_radix_enum.UVM_BIN:        "b",
        uvm_radix_enum.UVM_OCT:        "o",
        uvm_radix_enum.UVM_DEC:        "d",
        uvm_radix_enum.UVM_HEX:        "h",
        uvm_radix_enum.UVM_UNSIGNED:   "u",
        uvm_radix_enum.UVM_UNFORMAT2:  "u",
        uvm_radix_enum.UVM_UNFORMAT4:  "z",
        uvm_radix_enum.UVM_STRING:     "s",
        uvm_radix_enum.UVM_TIME:       "t",
        uvm_radix_enum.UVM_ENUM:       "s",
        uvm_radix_enum.UVM_REAL:       "g",
        uvm_radix_enum.UVM_REAL_DEC:   "f",
        uvm_radix_enum.UVM_REAL_EXP:   "e"
    }
    
    if radix in radix_m.keys():
        return radix_m[radix] 
    else:
        return "x"
...
class uvm_severity(Enum):
    UVM_INFO = auto()
    UVM_WARNING = auto()
    UVM_ERROR = auto()
    UVM_FATAL = auto()
    
UVM_INFO = uvm_severity.UVM_INFO
UVM_WARNING = uvm_severity.UVM_WARNING
UVM_ERROR = uvm_severity.UVM_ERROR
UVM_FATAL = uvm_severity.UVM_FATAL
