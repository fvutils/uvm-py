...
# class uvm_typeid_base():
#     typename = ""
#     typeid_map = {} # map<uvm_typeid_base,uvm_callbacks_base>
#     type_map = {} # map<uvm_callbacks_base,uvm_typeid_base>
...
# #------------------------------------------------------------------------------
# 
# class uvm_typeid#(type T=uvm_object) (uvm_typeid_base):;
...
#       if(m_b_inst != m_this_type[i]  and  m_this_type[i].m_is_registered(obj,cb))
#         return 1;
# 
#     if(obj  is None) begin
#       foreach(m_derived_types[i]) begin
#         dt = uvm_typeid_base::typeid_map[m_derived_types[i] ];
#         if(dt != null  and  dt.check_registration(null,cb))
#           return 1;
#       end
#     end
# 
...
# 
# class uvm_typed_callbacks#(type T=uvm_object) (uvm_callbacks_base):;
# 
...
#     elif:(obj != null) tname = obj.get_type_name();
#     else tname = "*";
# 
...
#       inst_q.append("(*)");
#       if(cb.is_enabled()) mode_q.append("ON");
#       else mode_q.append("OFF");
# 
#       str = cb.get_name();
...
#       end
#       if(me != null  or  m_t_inst.m_tw_cb_q.size()) begin
#         qs.append($sformatf("Registered callbacks for all instances of %s\n", tname)); 
#         qs.append("---------------------------------------------------------------\n");
#       end
#       if(me != null) begin
#         do begin
...
#               cb = q.get(i);
#               cbq.append(cb.get_name());
#               inst_q.append(bobj.get_full_name());
#               if(cb.is_enabled()) mode_q.append("ON");
#               else mode_q.append("OFF");
#   
#               str = cb.get_name();
...
#       end
#       else begin
#         qs.append($sformatf("No callbacks registered for any instances of type %s\n", tname));
#       end
#     end
#     else begin
#       if(m_t_inst.m_pool.exists(bobj)  or  m_t_inst.m_tw_cb_q.size()) begin
#        qs.append($sformatf("Registered callbacks for instance %s of %s\n", obj.get_full_name(), tname)); 
#        qs.append("---------------------------------------------------------------\n");
#       end
...
#         m_base_inst.m_this_type.append(m_inst);
#       end
# 
#       if (m_inst  is None)
...
# 
#   virtual function bit m_is_registered(uvm_object obj, uvm_callback cb);
#     if(m_is_for_me(cb)  and  m_am_i_a(obj)) begin
#       return m_registered;
#     end
#   endfunction
# 
...
#           q.append(m_t_inst.m_tw_cb_q.get(i)); 
#       end
# 
...
#     if(!found) begin
#       string nm;
#       if(obj is None) nm = "(*)"; else nm = obj.get_full_name();
...
#       q = (obj  is None) ? m_t_inst.m_tw_cb_q : m_t_inst.m_get_tw_cb_q(obj);
#     end 
#     else begin
#       q = m_base_inst.m_pool.get(obj);
#       if(q is None) begin
...
#       if($cast(cb, q.get(itr))  and  cb.callback_mode())
#          return cb;
#     return null;
#   endfunction
# 
...
#     #
#     #| static function void get_all( ref CB all_callbacks[$], input T obj=None );
#     #
...
#     s_obj.m_derived_types.append(m_typeid);
#     return 1;
#   endfunction
# 
# endclass
...
#       if (m_cb != null  and  T::cbs::get_debug_flags() & UVM_CALLBACK_TRACE) begin
...
#          elif: (m_obj != null) who = {m_obj.get_full_name(), " is executing "};
...
# # class that (from): this class. In it, he defines one or more virtual
...
#   def __init__(string name="uvm_callback");
#     super.new(name);
#   endfunction
# 
# 
